...
const workspaceTitles = document.querySelectorAll('.workspace h2');

workspaceTitles.forEach(title => {
    title.addEventListener('click', () => {
        const workspaceName = title.textContent.trim(); // Get workspace name
        const workspace = workspaces.find(workspace => workspace.name === workspaceName); // Find the workspace object
...
const workspaceTitles = document.querySelectorAll('.workspace');
